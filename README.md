...
treefmt-nix.lib.mkWrapper nixpkgs {
  ...
  formatter.terraform.enable = true;
  # Override the default package
  formatter.terraform.command = nixpkgs.terraform_1_0;
  # Override the default settings generated by the above option
  formatter.terraform.excludes = ["hello.tf"];
}
```
...
<!-- `> ls formatter/*.nix | grep -v default.nix | cut -d '.' -f 1 | cut -d / -f 2 | LC_ALL=C sort | sed -e 's/^/* /'` -->
<!-- BEGIN mdsh -->
* alejandra
* black
* cabal-fmt
